...
internal static class GeometryHelper
{
    ...
    /// </summary>
    public static long Area(PointLong a, PointLong b, PointLong c)
    {
    ...
    /// calculation  to work.
    /// </summary>
    public static double Area(IList<PointDouble> points)
    {
        double area = 0;
    ...
    /// Code 7.13 pg 244.
    /// </summary>
    public static Containment PolygonContainsPoint(IList<PointLong> points, PointLong point)
    {
        var rCross = 0;
        var lCross = 0;
        ...
        for (var i = 0; i < points.Count; i++)
        {
            ...
            if (Math.Abs(points[i].X) < GeometryConstants.Tolerance && Math.Abs(points[i].Y) < GeometryConstants.Tolerance)
            {
    ...
    /// </summary>
    public static PolygonOrientation GetOrientation(IList<PointDouble> points)
    {
        if (points.Count < 3)
        {
    ...
    {
        return val > -GeometryConstants.Tolerance && val < GeometryConstants.Tolerance;
    }
    ...
    internal static bool PointOnLineSegment(
        PointLong point,
        PointLong linePoint1,
        PointLong linePoint2,
        bool useFullRange)
    {
        if (useFullRange)
        {
    ...
    /// </summary>
    internal static bool PointIsVertex(PointLong point, OutputPoint polygon)
    {
        var polygonPoint = polygon;
        do
        {
            if (polygonPoint.Point == point)
            {
                return true;
            }
    ...
    /// </summary>
    internal static bool PointOnPolygon(PointLong point, OutputPoint polygon, bool useFullRange)
    {
        var polygonPoint = polygon;
        while (true)
        {
    ...
    /// </summary>
    internal static bool SlopesEqual(PointLong point1, PointLong point2, PointLong point3, bool useFullRange)
    {
        if (useFullRange)
        {
    ...
    /// </summary>
    internal static bool SlopesEqual(PointLong point1, PointLong point2,
        PointLong point3, PointLong point4, bool useFullRange)
    {
        if (useFullRange)
        {
    ...
    /// </summary>
    internal static void RangeTest(PointLong point, ref bool useFullRange)
    {
        while (true)
        {
            if (useFullRange)
    ...
    internal static double DistanceFromLineSqrd(PointLong point, PointLong linePoint1, PointLong linePoint2)
    {
    ...
    internal static bool SlopesNearCollinear(
        PointLong point1, PointLong point2, PointLong point3, double distanceSquared)
    {
    ...
    internal static bool PointsAreClose(PointLong point1, PointLong point2, double distSqrd)
    {
    ...
    internal static bool Pt2IsBetweenPt1AndPt3(PointLong point1, PointLong point2, PointLong point3)
    {
    ...
    public static double GetDx(PointLong point1, PointLong point2)
    {
    ...
    public static double GetDxSignedLength(PointLong point1, PointLong point2)
    {
