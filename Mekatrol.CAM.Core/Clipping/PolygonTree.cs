...
public class PolygonTree : PolygonNode, IClipSolution
{
    ...
    /// </summary>
    public List<PolygonNode> AllPolygons { get; } = [];
    ...
    public PolygonLongPath GetPath()
    {
        var path = new PolygonLongPath { Capacity = Children.Count };
        AddNodeToPath(this, NodeType.Any, path);
        return path;
    }

    public PolygonLongPath GetOpenPath()
    {
        var path = new PolygonLongPath { Capacity = Children.Count };
    ...
    public PolygonLongPath GetClosedPath()
    {
        var path = new PolygonLongPath { Capacity = Children.Count };
    ...
    private static void AddNodeToPath(PolygonNode node, NodeType nodeType, PolygonLongPath paths)
    {
        var match = true;
